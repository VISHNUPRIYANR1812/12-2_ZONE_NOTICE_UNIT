...
MD_Parola P = MD_Parola(HARDWARE_TYPE, DATA_PIN, CLK_PIN, CS_PIN, MAX_DEVICES);// Use GPIO 16 as D8 on ESP8266, and 4 as the number of devices for ESP32
WebServer server(80);
...
void setup(void)
{
  ...
  WiFi.begin("realme 10 Pro 5G", "#Realme10pro"); // Replace with your WiFi credentials
